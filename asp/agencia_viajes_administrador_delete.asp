		...
		<table border = 1>
			<%
				...
				do while not origen.EOF
					Response.Write ("<tr><td><a href=agencia_viajes_administrador_delete_exito.asp?id=" & origen("IDCIUDAD") & " > <b><font color=red> X </font></b> </a></td><td> " & origen("CIUDAD") & "</td><td> " & origen("TASA_AEROPUERTO") & "</td></tr> ")
